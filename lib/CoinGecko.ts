...
class CoinGecko {
    ...
    static REQUESTS_PER_SECOND: number;
    static TIMEOUT: any;
    static ORDER: any;
    static STATUS_UPDATE_CATEGORY: any;
    static STATUS_UPDATE_PROJECT_TYPE: any;
    static EVENT_TYPE: any;
    ...
    get coins() {
        ...
        return {
             ...
             * @returns {ReturnObject}
             */
            fetchTickers: (coinId: any, params: any = {}) => {
                //Must have coinId
                if (!Utils.isString(coinId) || Utils.isStringEmpty(coinId)) Utils._WARN_('Invalid parameter', 'coinId must be of type: String and greater than 0 characters.');
             ...
             * @returns {ReturnObject}
             */
            fetchHistory: (coinId: any, params: any = {}) => {
                //Must have coinId
                if (!Utils.isString(coinId) || Utils.isStringEmpty(coinId)) Utils._WARN_('Invalid parameter', 'coinId must be of type: String and greater than 0 characters.');
             ...
             * @returns {ReturnObject}
             */
            fetchMarketChart: (coinId: any, params: any = Object) => {
                //Must have coinId
                if (!Utils.isString(coinId) || Utils.isStringEmpty(coinId)) Utils._WARN_('Invalid parameter', 'coinId must be of type: String and greater than 0 characters.');
             ...
             * @returns {ReturnObject}
             */
            fetchMarketChartRange: (coinId: any, params: any = {}) => {
                //Must have coinId
                if (!Utils.isString(coinId) || Utils.isStringEmpty(coinId)) Utils._WARN_('Invalid parameter', 'coinId must be of type: String and greater than 0 characters.');
             ...
             * @function coins.fetchCoinsOhlc()
             * @param {string} coinId - (Required) The coin id (can be obtained from coins.list()) eg. bitcoin
             * @param {object} params - Parameters to pass through to the request
             * @param {number} params.vs_currency - The target currency of market data (usd, eur, jpy, etc.)
             * @param {number} params.days - Data up to number of days ago (1/7/14/30/90/180/365/max)
             * @returns {ReturnObject}
             */
            fetchCoinsOhlc: (coinId: any, params: any = {}) => {
                //Must have coinId
                if (!Utils.isString(coinId) || Utils.isStringEmpty(coinId)) Utils._WARN_('Invalid parameter', 'coinId must be of type: String and greater than 0 characters.');
                ...
                //If no params.days, set to default: '1'
                if (!Utils.isString(params['days']) || Utils.isStringEmpty(params['days'])) {
                    params.days = '1';
                }
             ...
             * @returns {ReturnObject}
             */
            fetchStatusUpdates: (coinId: any, params = {}) => {
                //Must have coinId
                if (!Utils.isString(coinId) || Utils.isStringEmpty(coinId)) Utils._WARN_('Invalid parameter', 'coinId must be of type: String and greater than 0 characters.');
             ...
             * @returns {ReturnObject}
             */
            fetchCoinContractInfo: (contractAddress: any, assetPlatform = 'ethereum') => {
             ...
             * @returns {ReturnObject}
             */
            fetchCoinContractMarketChart: (contractAddress: any, assetPlatform = 'ethereum', params: any = {}) => {
                //Must have contractAddress, assetPlatform
                if (!Utils.isString(contractAddress) || Utils.isStringEmpty(contractAddress)) Utils._WARN_('Invalid parameter', 'contractAddress must be of type: String and greater than 0 characters.');
                if (!Utils.isString(assetPlatform) || Utils.isStringEmpty(assetPlatform)) Utils._WARN_('Invalid parameter', 'assetPlatform must be of type: String and greater than 0 characters.');
             ...
             * @returns {ReturnObject}
             */
            fetchCoinContractMarketChartRange: (contractAddress: any, assetPlatform = 'ethereum', params: any = {}) => {
                //Must have contractAddress, assetPlatform
                if (!Utils.isString(contractAddress) || Utils.isStringEmpty(contractAddress)) Utils._WARN_('Invalid parameter', 'contractAddress must be of type: String and greater than 0 characters.');
                if (!Utils.isString(assetPlatform) || Utils.isStringEmpty(assetPlatform)) Utils._WARN_('Invalid parameter', 'assetPlatform must be of type: String and greater than 0 characters.');
            ...
            /**
             * @description Use this to obtain all the coins’ id in order to make API calls
             * @function coins.fetchCoinsCategories()
             * @param {object} params - Parameters to pass through to the request
             * @param {string} params.order [default: usd] - (Required) The target currency of market data (usd, eur, jpy, etc.)
             * @returns {ReturnObject}
             */
            fetchCoinsCategories: (param?: any) => {
                const path = `/${pathPrefix}/categories`;
                return this._request(path, param);
            },

            /**
             * @description Use this to obtain all the coins’ id in order to make API calls
             * @function coins.fetchCoinsCategoriesList()
             * @returns {ReturnObject}
             */
            fetchCoinsCategoriesList: () => {
                const path = `/${pathPrefix}/categories/list`;
                return this._request(path);
            },
        };
    };
    ...
    get exchanges() {
        ...
        return {
             ...
             * @returns {ReturnObject}
             */
            fetchTickers: (exchangeId: any, params: any = {}) => {
                //Must have exchangeId
                if (!Utils.isString(exchangeId) || Utils.isStringEmpty(exchangeId)) Utils._WARN_('Invalid parameter', 'exchangeId must be of type: String and greater than 0 characters.');
             ...
             * @returns {ReturnObject}
             */
            fetchStatusUpdates: (exchangeId: any, params = {}) => {
                //Must have exchangeId
                if (!Utils.isString(exchangeId) || Utils.isStringEmpty(exchangeId)) Utils._WARN_('Invalid parameter', 'exchangeId must be of type: String and greater than 0 characters.');
             ...
             * @returns {ReturnObject}
             */
            fetchVolumeChart: (exchangeId: any, params = {}) => {
                //Must have exchangeId
                if (!Utils.isString(exchangeId) || Utils.isStringEmpty(exchangeId)) Utils._WARN_('Invalid parameter', 'exchangeId must be of type: String and greater than 0 characters.');
    ...
    get simple() {
        return {
             ...
             * @returns {ReturnObject}
             */
            fetchTokenPrice: (params: any = {}, assetPlatform = 'ethereum') => {
                //Must be object
                if (!Utils.isObject(params)) Utils._WARN_('Invalid parameter', 'params must be of type: Object');
    ...
    get derivatives() {
        ...
        return {
             ...
             * @returns {ReturnObject}
             */
            fetchExchange: (exchangeId: any, params = {}) => {
                //Must have exchangeId
                if (!Utils.isString(exchangeId) || Utils.isStringEmpty(exchangeId)) Utils._WARN_('Invalid parameter', 'exchangeId must be of type: String and greater than 0 characters.');
     ...
     */
    _request(path: string, params?: object | undefined): Promise<any> {
        //Make relative path
        //Check if has params, append accordingly
        if (params === undefined) path = `/api/v${Constants.API_VERSION}${path}`;
        else path = `/api/v${Constants.API_VERSION}${path}?`;

        let options: AxiosRequestConfig = {
            url: path,
            method: 'GET',
            baseURL: 'https://' + Constants.HOST,
            params,
            headers: {
